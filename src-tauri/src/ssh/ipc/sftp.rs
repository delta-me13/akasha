...
//! | 会话怎么开 | `crate::ssh::SftpClient`（在一条流上的 SFTP 会话，ADR-0006 D2） |
//! | 文件怎么搬 | `crate::ssh::transfer`（只认两个 [`Endpoint`]，ADR-0006 D4） |
...
use crate::ssh::transfer::{Cancel, Endpoint, Listing, Progress, TransferRequest};
use crate::ssh::{InFlight, LocalEndpoint, SftpClient, SshConnection};
...
impl From<crate::ssh::transfer::EntryKind> for SftpEntryKind {
    fn from(kind: crate::ssh::transfer::EntryKind) -> Self {
        match kind {
            crate::ssh::transfer::EntryKind::File => Self::File,
            crate::ssh::transfer::EntryKind::Directory => Self::Directory,
            crate::ssh::transfer::EntryKind::Symlink => Self::Symlink,
            crate::ssh::transfer::EntryKind::Other => Self::Other,
        }
    }
}
...
impl From<crate::ssh::SshError> for SftpError {
...
impl Tracked {
    ...
    fn finish(&self, outcome: Result<u64, crate::ssh::SshError>) {
        ...
        match outcome {
            ...
            Err(crate::ssh::SshError::Cancelled) => slot.state = SftpTransferState::Cancelled,
            Err(err) => {
