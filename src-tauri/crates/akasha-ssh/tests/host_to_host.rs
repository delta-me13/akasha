...
use akasha_ssh::testing::{Relay, Running, ServerOptions, SftpItem, start};
use akasha_ssh::transfer::{Cancel, Progress, TransferRequest, transfer};
...
fn target_options(target: &Running, cache: Arc<CredentialCache>) -> akasha_ssh::SshConnect {
    connect_options_to(
